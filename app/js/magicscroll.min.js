...
let headerSpace = $('header').outerHeight();
let infiniteHeight = $(window).height() - headerSpace - $('.btns-top').innerHeight();

var MagicScrollOptions = {
		height: infiniteHeight,
		width: "100%",
		items: window.innerWidth >= 1025 ? 4 : 4,
		step: window.innerWidth >= 1025 ? 1 : "auto",
		speed: 80,
		orientation: "vertical",
		scrollOnWheel: !0,
		draggable: !1,
		keyboard: !1,
		easing: "cubic-bezier(.13,.62,.55,.93)",
		arrows: "off",
		onReady: function () {
			$(".MagicScroll").addClass("ready");
			var e,
				o,
				r = $(".scrolling-text-content .item");
			r.mouseover(function () {
				return (
					(e = $(this).data("bg-color")),
						(o = $(this).data("fx")),
						$("body").css("background-color", e).addClass("text-hover"),
						$(".hover-image")
							.eq(o - 1)
							.hasClass("hoverOut")
							? ($(".hover-image").removeClass("hoverOut"),
								$(".hover-image")
									.eq(o - 1)
									.addClass("hovered"))
							: $(".hover-image")
				...
				r.mouseleave(function () {
					return (
						(e = $(this).data("bg-color")),
							(o = $(this).data("fx")),
							$("body").removeClass("text-hover"),
							$("body.page-template-home-page").css("background-color", "#fff").removeClass("text-hover"),
							$(".hover-image").removeClass("hovered"),
							$(".hover-image")
								.eq(o - 1)
								.addClass("hoverOut"),
							setTimeout(function () {
			...
			if (window.innerWidth <= 1024 || window.innerWidth === 1080) {
				$("body").css("background-color", $("#1").data("bg-color"));
			}
		},
	},
	MagicScrollMobileOptions = {
		...
		arrows: "off",
		onMoveEnd: function () {
			if (arguments[0].items.length === 1) {
				let id = arguments[0].items[0];
				$("body").css("background-color", $(`#${id + 1}`).data("bg-color"));
			}
		},
	};

$('.scrolling-text-content .item').on('mouseover', function(){
	if($(window).width() > 1024) {
		$('body').css({
			'background-image' : 'url('+$(this).find('.item-ipad-img img').attr('src')+')',
...
$('.scrolling-text-content .item').on('mouseleave', function(){
	if($(window).width() > 1024) {
		$('body').css("background", "#D8E377");
	}
})
